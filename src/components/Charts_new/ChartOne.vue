    ...
    >
      <div class="flex w-full flex-wrap gap-3 sm:gap-5">
        <div class="flex min-w-47.5">
          ...
          <div class="w-full">
            <p class="font-semibold text-primary">Bot Messages</p>
            <p class="text-sm font-medium">11.204</p>
          </div>
        </div>
        <div class="flex min-w-47.5">
          <span
          ...
          <div class="w-full">
            <p class="font-semibold text-secondary">Users Messages</p>
            <p class="text-sm font-medium">12.204</p>
          </div>
        </div>
      </div>
